...
class SubstationApp:
    ...
    def setup_ui(self):
        ...
        tk.Button(top, text="Select Stencil", command=self.on_select_stencil).grid(row=0, column=0, sticky="w")
    ...
    def build_matrix(self):
        ...
        for r in range(rows):
            ...
            for c in range(cols):
                ...
                cb = ttk.Combobox(cell_frame, state="readonly", width=36,
    ...
    def _on_master_selected(self, combobox, props_frame, label_entry=None):
        ...
        tk.Label(header, text="Type", font=("Arial", 9, "bold")).grid(row=0, column=0, sticky="w", padx=(0, 8))
        ...
        for p in props:
            ...
            tk.Label(row, text=t, anchor="w", width=20).grid(row=0, column=0, sticky="w", padx=(0, 8))
            tk.Label(row, text=v, anchor="w", wraplength=360, justify="left").grid(row=0, column=1, sticky="w")
